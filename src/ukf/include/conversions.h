/** @brief Conversions between coordinate systems.Includes LatLong<->UTM.
...
/** @brief Utility function to convert geodetic to UTM position

Units in are floating point degrees (sign for east/west) .Units out are meters
 */
...
/** @brief Determine the correct UTM letter designator for the given lat
...
/** @brief Convert lat/long to UTM coords.  Equations from USGS Bulletin 1532

East Longitudes are positive, West longitudes are negative.
North latitudes are positive, South latitudes are negative Lat and Long are in fractional degrees
 */
